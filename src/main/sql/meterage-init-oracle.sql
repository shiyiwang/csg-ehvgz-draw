...
set feedback off
set define off
prompt Creating CDE_DEPARTMENT...
...
alter table CDE_DEPARTMENT
  add constraint FK47381E3A1CC80208 foreign key (F_PARENT_ID)
  references CDE_DEPARTMENT (F_ID);

prompt Creating CDE_ACCOUNT...
...
alter table CDE_MENUITEM
  add constraint FK57F141DAED0F3FE3 foreign key (F_PARENT_ID)
  references CDE_MENUITEM (F_ID);

prompt Creating CDE_PERMISSION...
...
alter table CDE_PERMISSION

prompt Creating CDE_ROLE...
...
alter table CDE_ROLE_PERMISSION
  ...
  references CDE_PERMISSION (F_ID);
alter table CDE_ROLE_PERMISSION
  add constraint FK5157EB50CD4BE4EA foreign key (F_ROLE_ID)
  references CDE_ROLE (F_ID);

prompt Creating CDE_SETTINGITEM...
...
prompt Creating CDE_DB_VERSION...
create table CDE_DB_VERSION
(
  F_ID          VARCHAR2(255 CHAR) primary key,
...
prompt Creating CDE_ATTACHMENT...
...
prompt Loading CDE_DEPARTMENT...
prompt Table is empty
prompt Loading CDE_ACCOUNT...
...
prompt Loading CDE_MENUITEM...
insert into CDE_MENUITEM (F_ID, F_DESC, F_ICON, F_NAME, F_OPTION, F_PATH, F_PARENT_ID)
...
prompt Loading CDE_ROLE...
insert into CDE_ROLE (F_ID, F_DESC, F_SCAFFOLD, F_NAME, F_DEPARTMENT_ID)
values ('26c49fad-dc2b-4b9a-b8fc-88324e3e0d70', null, null, '系统管理员', null);
commit;
prompt 1 records loaded
prompt Loading CDE_ROLE_ACCOUNT...
insert into CDE_ROLE_ACCOUNT (F_ROLE_ID, F_ACCOUNT_ID)
values ('26c49fad-dc2b-4b9a-b8fc-88324e3e0d70', '799eb843-d9cd-460b-9c7c-5db6abacca40');
commit;
prompt 1 records loaded
prompt Loading CDE_ROLE_PERMISSION...
...
commit;
prompt 17 records loaded
prompt Loading CDE_SETTINGITEM...
prompt Table is empty
set feedback on
set define on
prompt Done.
